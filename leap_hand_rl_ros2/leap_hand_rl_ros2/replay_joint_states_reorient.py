"""Replay recorded reorient joint states on /hand/joint_commands."""
...
class JointStateReplay(Node):
    def __init__(self, data_path: str, loop: bool, rate_hz: float | None) -> None:
        super().__init__("replay_joint_states_reorient")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Replay recorded reorient joint states.")
