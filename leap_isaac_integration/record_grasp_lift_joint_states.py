...
"""Record joint states from a grasp-lift checkpoint into an .npz file."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Record grasp-lift joint states from a checkpoint.")
    ...
    task_id = "Isaac-Leap-Grasp-Lift-v0"
    ...
    if args.filename:
        ...
        out_name = f"grasp_lift_joint_states_{ts}.npz"
